...
4. "Disable open responses" in your initial welcome message chatflow.
5. Your AI assistant will now only begin responding after the AI chat button has been pressed.
