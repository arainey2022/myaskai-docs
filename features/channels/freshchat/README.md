...
8. Your AI agent is now connected to Freshchat and will be [providing "note" responses](./#how-to-draft-ai-conversational-replies-to-users-without-sending-them) (not directly to customers).
...
It will retain all the [same features of the Freshchat agent](./#how-can-i-use-my-ai-chatbot-within-intercom), including human escalation, but within the respective platforms.
